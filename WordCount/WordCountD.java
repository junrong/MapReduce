...
public class WordCountD {
	...
	public static class TokenizerMapper extends
		...
		// Override the setup function to initialize the HashMap data structure 
		@Override
		protected void setup(Context context) throws IOException,
				InterruptedException {
			super.setup(context);
			//Initializing the HashMap RealWordMap
		...
		// Override the cleanup function to clean the HashMap after all Map calls
		@Override
		protected void cleanup(Context context) throws IOException,
				InterruptedException {
			super.cleanup(context);
			//Emit the key from HashMap
			Iterator<Entry<Text, IntWritable>> iterator = RealWordMap
					.entrySet().iterator();
			while (iterator.hasNext()) {
				Text keyText = iterator.next().getKey();
				context.write(keyText, RealWordMap.get(keyText));
			}
